...
fpath    = fullfile(rootpath,datapath); % where on disk do you want the simulation? ideally and SSD...
...
ops.Nchan               = 49;           % number of active channels (omit if already in chanMap file)
...
ops.chanMap             = '/opt/KiloSort/configFiles/chanMapPG_K4.mat'; % make this file using createChannelMapFile.m		
